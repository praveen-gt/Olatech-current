...
const OlaAspire = () => {
  ...
  return (
    <>
      <div>
        <Banner
          title={"Fulfill aspirations by making learning easier with OLA LMS for RTOs"}
          rightImage={'ola-lms-aspire-hero.png'}
          imageWidth={527}
          imageHeight={585}
          bgImage={'ola-aspire-banner-bg.png'}
