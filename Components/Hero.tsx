...
function Hero() {
  return (
    <section>
      ...
      <div className= {`container  px-6 mx-auto space-y-0 md:space-y-0 relative `}>
        <div className="-z-1">
          <Image
        ...
        <div className="container flex flex-col md:flex-row px-4 mx-auto mt-10 justify-between">
          <div className={`${styles.herobanner} ${styles.heroWidth}`} style={{zIndex: 0}}>
            <h1 className='trumpBold'>New age e-learning solutions for RTOs, Universities, and Corporates.</h1>
